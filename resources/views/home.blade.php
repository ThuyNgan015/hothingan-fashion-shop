...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-1"></div>
            <div class="col-5">
                <img src="https://images.squarespace-cdn.com/content/v1/641c25fa1612177d84e30035/b941a9c7-a45b-4960-aafb-f97a575f91f2/Elizabeth+Formosa+Fashion+Business+Consultant+Fashion+Equipped+Fashion+Business+Strategist_1.jpg" alt="ảnh" width="500px" height="600px">
            </div>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="card" style="width:18rem;">
                                <img src="https://hips.hearstapps.com/hmg-prod/images/elm030124insidecover-002a-65d789635eadc.jpg?crop=1.00xw:0.786xh;0,0.0191xh&resize=640:*" alt="" height="300px">
                        ...
                        <div class="col-4">
                            <div class="card" style="width:18rem;">
                                <img src="https://assets.ajio.com/medias/sys_master/root/20230718/DElg/64b6be4aeebac147fc7727a1/-473Wx593H-466368522-black-MODEL.jpg" alt="" height="300px">
                                <div class="card-body pl-2">
                                    <h5>women fashion</h5>
                                    <h4 class="card-text">woman black dress</h4>
                                    <div class='d-flex'>
                        ...
                        <div class="col-4">
                            <div class="card" style="width:18rem;">
                                <img src="https://m.media-amazon.com/images/I/41JQsjyf8uL._AC_UY1100_.jpg" alt="" height="300px">
                                <div class="card-body pl-2">
                                    <h5>women fashion</h5>
                                    <h4 class="card-text">woman black dress</h4>
                                    <div class='d-flex'>
    ...
    <div class="container background3">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="card" style="width:18rem;">
                    <img src="https://assets.ajio.com/medias/sys_master/root/20230706/Hidn/64a616c2eebac147fc5117f9/-1117Wx1400H-466337036-black-MODEL2.jpg" alt="" height="300px">
                    <div class="card-body pl-2">
                        <h5>women fashion</h5>
                        <h4 class="card-text">woman black dress</h4>
                        <div class='d-flex'>
            ...
            <div class="col-3">
                <div class="card" style="width:18rem;">
                    <img src="https://assets.ajio.com/medias/sys_master/root/20230808/RUfE/64d1c384a9b42d15c9964f65/-288Wx360H-466431196-pink-MODEL.jpg" alt="" height="300px">
                    <div class="card-body pl-2">
                        <h5>women fashion</h5>
                        <h4 class="card-text">woman black dress</h4>
                        <div class='d-flex'>
            ...
            <div class="col-3">
                <div class="card" style="width:18rem;">
                    <img src="https://assets.ajio.com/medias/sys_master/root/20220902/ione/63112c02f997dd1f8dd5fa50/-473Wx593H-464924245-blue-MODEL5.jpg" alt="" height="300px">
                    <div class="card-body pl-2">
                        <h5>women fashion</h5>
                        <h4 class="card-text">woman black dress</h4>
                        <div class='d-flex'>
